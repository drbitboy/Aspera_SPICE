...
def get_fov(UTC, galaxy_targ):
    ...
    instrument (using -1999301 = ASP_SLIT_1 and -1999302 = ASP_SLIT_2 for this test)
    ...
    Returns:
        ...
        ASP_SLIT_1 at the given UTC time. boolean2 is true if galaxy_targ is in the fov of
        ASP_SLIT_2 at the given UTC time
    '''
    et = sp.str2et(UTC)
